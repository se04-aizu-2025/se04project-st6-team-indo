...
urlpatterns = [
    ...
    path('heap/run/', views.bubble_sort_view, name='heap_run'),
    path('insertion/run/', views.bubble_sort_view, name='insertion_run'),
    path('merge/run/', views.bubble_sort_view, name='merge_run'),
    path('quick/run/', views.bubble_sort_view, name='quick_run'),
    path('selection/run/', views.bubble_sort_view, name='selection_run'),
]